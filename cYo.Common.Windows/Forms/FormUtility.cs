    ...
    public static class FormUtility
    {
        ...
        public static bool PanelToTab(Control control, bool on, Action<bool> setState = null)
        {
            ...
            if (control.Tag is TabControl)
            {
                ...
                ColorSchemeExtensions.SetColorScheme(control);
                UXTheme.ApplyDarkThemeRecursive(control, ColorSchemeExtensions.IsDarkModeEnabled);
            ...
            else
            {
                ...
                ColorSchemeExtensions.SetColorScheme(tabControl2);
                UXTheme.ApplyDarkThemeRecursive(tabControl2, ColorSchemeExtensions.IsDarkModeEnabled);
