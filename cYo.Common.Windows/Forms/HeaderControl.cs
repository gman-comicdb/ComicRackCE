...
namespace cYo.Common.Windows.Forms
{
    public class HeaderControl : Control
    {
        ...
        {
            Color controlDark = ColorSchemeExtensions.IsDarkModeEnabled ? SystemColors.ControlLight : SystemColors.ControlDark;
            ...
            Image themedArrowDown = ColorSchemeExtensions.IsDarkModeEnabled ? darkSortDownImage : sortDownImage;
            Image themedSortUpImage = ColorSchemeExtensions.IsDarkModeEnabled ? darkSortUpImage : sortUpImage;
            Image themedDropDownImage = ColorSchemeExtensions.IsDarkModeEnabled ? darkDropDownImage : dropDownImage;
