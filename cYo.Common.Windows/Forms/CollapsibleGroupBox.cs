    ...
    public class CollapsibleGroupBox : ContainerControl
    {
        ...
        private Image GetToggleImage()
        {
            ...
            if (!collapsed)
            {
                ...
                if (obj == null)
                {
                    return ColorSchemeExtensions.IsDarkModeEnabled ? darkArrowDown : arrowDown;
                }
            }
            else
            {
                obj = collapsedImage ?? (ColorSchemeExtensions.IsDarkModeEnabled ? darkArrowRight : arrowRight);
            }
            return (Image)obj;
        }
