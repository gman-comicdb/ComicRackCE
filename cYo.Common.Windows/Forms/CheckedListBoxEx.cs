...
namespace cYo.Common.Windows.Forms
{
	public class CheckedListBoxEx : CheckedListBox
	{
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
		{
            ...
            e.DrawThemeBackground(drawFocus: true, focused: this.Focused);
			...
			// Might be related to FocusRectangle being drawn around entire Control when it shouldn't be.
			if ((e.State & DrawItemState.Focus) != 0 && (e.State & DrawItemState.NoFocusRect) == 0)
			{
                ...
                ControlPaintEx.DrawFocusRectangle(e.Graphics, textRectangle);
            }
		}
