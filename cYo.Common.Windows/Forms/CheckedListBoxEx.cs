    ...
    public class CheckedListBoxEx : CheckedListBox
    {
        ...
        public CheckedListBoxEx()
        {
            if (ColorSchemeExtensions.IsDarkModeEnabled)
            {
                ...
                BackColor = Color.FromArgb(56, 56, 56); // SystemColors change leading to different item & background colors - cba to figure out why right now
