    ...
    public partial class MatcherEditor : UserControl, IMatcherEditor
    {
        ...
        public MatcherEditor(ComicBookMatcherCollection matchers, ComicBookValueMatcher comicBookMatcher, int level, int width)
        {
            ...
            if (ColorSchemeExtensions.IsDarkModeEnabled)
            {
                ...
                btMatcher.BackColor = Color.FromArgb(51, 51, 51);
                btMatcher.FlatAppearance.CheckedBackColor = Color.FromArgb(51, 51, 51);
                btMatcher.FlatAppearance.MouseOverBackColor = Color.FromArgb(51, 51, 51);
                //btMatcher.FlatAppearance.BorderSize = 1;
                //btMatcher.FlatAppearance.BorderColor = Color.FromArgb(155, 155, 155);
            }
        }
