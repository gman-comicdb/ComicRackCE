...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
    public partial class PreferencesDialog : Form
    {
        ...
        public PreferencesDialog()
        {
            ...
            {
                // panekl back color is overridden in SetColorScheme
                //panelReaderOverlays.BackColor = Color.Red;// SystemColors.ControlLight;
        ...
        private void AddSharePage(ComicLibraryServerConfig cfg)
        {
            ...
            if (ColorSchemeExtensions.IsDarkModeEnabled)
            {
                ColorSchemeExtensions.SetColorScheme(tab);
                ColorSchemeExtensions.SetColorScheme(sc);
                UXTheme.ApplyDarkThemeRecursive(tab, ColorSchemeExtensions.IsDarkModeEnabled);
                UXTheme.ApplyDarkThemeRecursive(sc, ColorSchemeExtensions.IsDarkModeEnabled);
            }
            tab.Controls.Add(sc);
