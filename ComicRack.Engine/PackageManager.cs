...
public class PackageManager
{
    ...
    public class Package
    {
        ...
        public bool Installed => PackageType != PackageType.Installed ? PackageType == PackageType.PendingInstall : true;
        ...
        {
            IniFile iniFile = new(Path.Combine(PackagePath, "package.ini"));
        ...
        public static void UnzipFile(string packagePath, string targetPath)
        {
            ...
            using (ZipFile zipFile = new(packagePath))
            {
        ...
        public static Package CreateFromPath(string name, string path, bool pending)
        {
            ...
            package.InitValues();
            package.PackageType = pending
                ? PackageType.PendingInstall
                : File.Exists(Path.Combine(path, ".remove")) ? PackageType.PendingRemove : PackageType.Installed;
            return package;
        }
